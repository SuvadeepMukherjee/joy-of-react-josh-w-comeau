...
## Creating a Hello World Application using JSX
...
(We are supplying attributes in expression slots.What will the JSX expression be converted  into during runtime )?
